...
public class AchievementActivity2500 extends AppCompatActivity {

    private static final int COST_SHARP_SCISSORS = 2500;
    private static final int REQUEST_IMPROVEMENTS = 2;
    private int clicks = 0; // Добавляем переменную для хранения очков

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_achievements_2500);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_IMPROVEMENTS && resultCode == RESULT_OK && data != null) {
            // ПЕРЕДАЕМ ДАННЫЕ НАЗАД В PastureActivity0
    ...
    private void setupImprovementButton() {
        ...
        if (currentClickValue == 3 && clicks >= COST_SHARP_SCISSORS) {
            ...
            improveButton.setOnClickListener(v -> {
                ...
                intent.putExtra("achievement_level", 2500);
