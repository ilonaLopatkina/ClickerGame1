...
public class AchievementActivity3500 extends AppCompatActivity {

    private static final int COST_EL_MACHINE = 3500;
    private static final int REQUEST_IMPROVEMENTS = 3;
    private int clicks = 0; // Добавляем переменную для хранения очков

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_achievements_3500);
    ...
    private void setupImprovementButton() {
        ...
        if (currentClickValue == 10 && clicks >= COST_EL_MACHINE) {
            ...
            improveButton.setOnClickListener(v -> {
                ...
                intent.putExtra("achievement_level", 3500);
